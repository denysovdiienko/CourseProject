...
<div>
    <form name="client" action="" method="POST">
        ...
        <div class="mb-3" style="width: 50%">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1"
                   aria-describedby="emailHelp" <@spring.formInput "form.typeOfProperty" "" "text"/>
        </div>
        <div class="mb-3" style="width: 50%">
        ...
        <div class="mb-3" style="width: 50%">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1"
                   aria-describedby="emailHelp" <@spring.formInput "form.phoneNumber" "" "text"/>
        </div>
        <div class="mb-3" style="width: 50%">
            <label for="exampleInputEmail1" class="form-label">ContactPerson</label>
            <input type="text" class="form-control" id="exampleInputEmail1"
                   aria-describedby="emailHelp" <@spring.formInput "form.contactPerson" "" "text"/>
        </div>
        <div class="mb-3" style="width: 50%">
