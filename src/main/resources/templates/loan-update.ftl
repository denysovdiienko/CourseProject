...
<h1>Update loan</h1>
<div>
    <form name="loan" action="" method="POST">
        ...
        <div class="mb-3" style="width: 50%">
            <label for="exampleInputEmail1" class="form-label">CodeType</label>
            <input type="text" class="form-control" id="exampleInputEmail1"
                   aria-describedby="emailHelp" <@spring.formInput "form.codeType" "" "text"/>
        </div>
